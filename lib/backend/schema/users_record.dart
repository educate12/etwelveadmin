...
abstract class UsersRecord implements Built<UsersRecord, UsersRecordBuilder> {
  ...
  @BuiltValueField(wireName: 'approved_subjects')
  BuiltList<DocumentReference>? get approvedSubjects;

  bool? get videoMemosEnabled;
  ...
  static void _initializeBuilder(UsersRecordBuilder builder) => builder
    ...
    ..cvReceived = false
    ..darkTheme = false
    ..approvedSubjects = ListBuilder()
    ..videoMemosEnabled = false;
