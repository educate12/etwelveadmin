    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'facebookVideos':
          ...
          break;
        case 'approved_tutors':
          result.approvedTutors.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(
                    DocumentReference, const [const FullType.nullable(Object)])
              ]))! as BuiltList<Object?>);
...
class _$SubjectsRecord extends SubjectsRecord {
  ...
  @override
  final BuiltList<DocumentReference<Object?>>? approvedTutors;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is SubjectsRecord &&
        ...
        approvedTutors == other.approvedTutors &&
        ffRef == other.ffRef;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'SubjectsRecord')
          ...
          ..add('approvedTutors', approvedTutors)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class SubjectsRecordBuilder
  ...
  ListBuilder<DocumentReference<Object?>>? _approvedTutors;
  ListBuilder<DocumentReference<Object?>> get approvedTutors =>
      _$this._approvedTutors ??= new ListBuilder<DocumentReference<Object?>>();
  set approvedTutors(ListBuilder<DocumentReference<Object?>>? approvedTutors) =>
      _$this._approvedTutors = approvedTutors;
  ...
  SubjectsRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _approvedTutors = $v.approvedTutors?.toBuilder();
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
    ...
    try {
      _$result = _$v ??
          new _$SubjectsRecord._(
              ...
              approvedTutors: _approvedTutors?.build(),
              ffRef: ffRef);
    } catch (_) {
      ...
      try {
        ...
        _$failedField = 'approvedTutors';
        _approvedTutors?.build();
      } catch (e) {
