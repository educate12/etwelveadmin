...
class ChooseSubject4FacebookWidget extends StatefulWidget {
  const ChooseSubject4FacebookWidget({
    Key? key,
    this.facebookClass,
  }) : super(key: key);

  final DocumentReference? facebookClass;

  @override
  _ChooseSubject4FacebookWidgetState createState() =>
      _ChooseSubject4FacebookWidgetState();
}

class _ChooseSubject4FacebookWidgetState
    extends State<ChooseSubject4FacebookWidget> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FacebookClassesRecord>(
      stream: FacebookClassesRecord.getDocument(widget.facebookClass!),
